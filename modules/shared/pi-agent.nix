...
let
  ...
  # SoL-Pi is not installed: Action Fusion is the one unique mechanism;
  # ObservationPack / OCC / EPR overlap Headroom + /compact.
  piExtensions = [ ./pi-extensions/action-fusion.ts ];
