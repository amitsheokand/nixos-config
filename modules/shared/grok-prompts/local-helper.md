...
Do:
- Search the tree the parent pointed at. Prefer MCP one-grep `search` when
  that server is registered; otherwise `zvec_grep_search`. Pass `root`
  `/home/amitsheokand/work/advait` (Mac: `/Users/amitsheokand/work/advait`)
